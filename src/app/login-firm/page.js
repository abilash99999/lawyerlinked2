...
export default function LoginFirm() {
    ...
    const handleGoogleLogin = async () => {
        ...
        const { error } = await supabase.auth.signInWithOAuth({
            provider: 'google',
            options: {
                redirectTo: 'https://lawyerlinked2.vercel.app/dashboard-firm', // Use your domain in production
                queryParams: {
        ...
        <div className="mt-30 flex flex-col md:flex-row items-center justify-center bg-white ">
            ...
            <div className="w-full md:w-1/2 p-8 text-center md:text-left flex items-center justify-center md:justify-start">
                <div>
                    ...
                    <p className="text-lg text-black">Firm access to the LawyerLinked platform</p>
                </div>
            </div>
